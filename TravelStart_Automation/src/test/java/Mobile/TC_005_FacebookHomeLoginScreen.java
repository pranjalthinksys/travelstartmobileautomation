...
public class TC_005_FacebookHomeLoginScreen extends Mobile_Base{
	...
	public static void Login()
	{
		...
		try {
			...
			Index.clickonFacebookbutton();
			GenerateReport.Logger_click(NodeType, "Facebook Button clicked again");
			Thread.sleep(2000);
			...
			GenerateReport.ValidationPass(NodeType, "Signout button clicked");
