...
public class TC_064_MyTrips_FacebookLogin_Screen extends Mobile_Base {
	...
	public static void Login()
	{
		...
		try {
			...
			//			Login.FBemailtext();
			//			GenerateReport.Logger_LauchApp(NodeType, "Facebook email");
			//			
			//			Login.FBpasswordtext();
			//			GenerateReport.Logger_LauchApp(NodeType, "Facebook password");
