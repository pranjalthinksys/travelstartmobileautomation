...
public class Preprod_Pending extends Web_Base {
	...
	public static void DirectLogin() throws InterruptedException, IOException
	{
		...
		Thread.sleep(3000);
				...
				WebElement Pendingbtn = getDriver().findElement(By.name("j_idt2:box1:j_idt80:j_idt108:6:j_idt110"));
				Pendingbtn.click();
				Thread.sleep(3000);

//		WebElement Paidbtn = getDriver().findElement(By.name("j_idt2:box1:j_idt82:j_idt110:3:j_idt112"));
//		Paidbtn.click();
//		Thread.sleep(3000);
